...
@EnableJpaAuditing
@ComponentScan({ "com.apixcloud.courses.persistence" })
@PropertySource({ "classpath:persistence-${persistenceTarget:h2}.properties" })
@EnableJpaRepositories(basePackages = "com.apixcloud.courses.persistence.daos")
public class UsersPersistenceJpaConfig {

    @Autowired
    private Environment env;

    public UsersPersistenceJpaConfig() {
        super();
    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[] { "com.apixcloud.courses" });

...
@ComponentScan({ "com.apixcloud.users.persistence" })
@PropertySource({ "classpath:persistence-${persistenceTarget:h2}.properties" })
@EnableJpaRepositories(basePackages = "com.apixcloud.users.persistence.daos")
public class UsersPersistenceJpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[] { "com.apixcloud.users" });
